!(function (e, t) {
	...
	function E(e, t) {
		...
		return (
			c(t, 'toString') && (e.toString = t.toString), c(t, 'valueOf') && (e.valueOf = t.valueOf), e
		);
	}
	function l(e, t, n, s) {
	...
	function A(e) {
		if (null == e._isValid) {
			...
			if (
				(e._strict &&
					(n = n && 0 === t.charsLeftOver && 0 === t.unusedTokens.length && void 0 === t.bigHour),
	...
	function ht(e) {
		for (var t, n, s, i, r = 0; r < e.length; ) {
			for (
				t = (i = lt(e[r]).split('-')).length, n = (n = lt(e[r + 1])) ? n.split('-') : null;
				0 < t;
	...
	function Nt(e) {
		var t,
			...
			i = e._i,
			r = e._f;
		if (((e._locale = e._locale || mt(e._l)), null === i || (void 0 === r && '' === i)))
				  ...
				  null !== (t = kt.exec(n._i))
						...
						: (St(n),
						  !1 === n._isValid &&
								...
								!1 === n._isValid &&
									(delete n._isValid,
									n._strict ? (n._isValid = !1) : f.createFromInputFallback(n)))))
				: a(r)
	...
	(i.add = Ce),
		...
		(i.inspect = function () {
			...
			return (
				this.isLocal() ||
					((t = 0 === this.utcOffset() ? 'moment.utc' : 'moment.parseZone'), (n = 'Z')),
				(t = '[' + t + '("]'),
			...
			return (
				null != this._tzm
					...
					: 'string' == typeof this._i &&
					  (null != (e = Vt(Se, this._i)) ? this.utcOffset(e) : this.utcOffset(0, !0)),
				this
			);
		}),
	...
	(w.calendar = function (e, t, n) {
		...
		(w.erasNarrowRegex = function (e) {
			return (
				c(this, '_erasNarrowRegex') || an.call(this), e ? this._erasNarrowRegex : this._erasRegex
			);
		}),
		...
		ct('en', {
			...
			ordinal: function (e) {
				...
				return (
					e +
					(1 === g((e % 100) / 10) ? 'th' : 1 == t ? 'st' : 2 == t ? 'nd' : 3 == t ? 'rd' : 'th')
				);
			},
		}),
	...
	return (
		...
		(U.humanize = function (e, t) {
			...
			return (
				...
				'object' == typeof t &&
					((s = Object.assign({}, On, t)), null != t.s && null == t.ss && (s.ss = t.s - 1)),
				(e = this.localeData()),
				(t = bn(this, !n, s, e)),
		...
		(f.relativeTimeThreshold = function (e, t) {
			return (
				void 0 !== On[e] && (void 0 === t ? On[e] : ((On[e] = t), 's' === e && (On.ss = t - 1), !0))
			);
		}),
