...
<style lang="postcss" global>
	...
	.header-wrapper > div > h2 {
		@apply md:mr-[35px] md:pl-[9px] xl:mr-[2vmax] xl:pl-[0.5vmax] font-bold text-base md:text-2xl xl:text-[1.5vmax] leading-[22px] md:leading-8 text-black dark:text-white;
	}
	.header-wrapper > h2 {
		@apply mt-[19px] xl:mt-[4vmax] font-bold text-black text-base md:text-[22px] xl:text-[1.5vmax] leading-[22px] md:leading-[30px] dark:text-white;
	}
	:local(.address) {
		@apply flex flex-row items-center gap-x-[11px] xl:gap-x-[1vmax] text-light-gardenText dark:text-white text-sm md:text-[18px] xl:text-[1.25vmax] font-medium;
	}
	.address > button {
		@apply h-full xl:h-[1.25vmax] w-auto flex items-center justify-center;
	}
</style>
